...
class VisionControllerClient(object):
    ...
    def DetectRegionTransform(self,regionname=None,cameranames=None):
    ...
    def VisualizePointCloudOnController(self,regionname=None,cameranames=None,pointsize=None):
    ...
    def SaveSnapshot(self,regionname=None, getlatest=None):
        ...
        if getlatest is not None:
            command['getlatest'] = 1 if getlatest else 0
        response = self._zmqclient.SendCommand(command)
        return response
